...
{ 
	...
	struct node* child[N]; // Ar ray Child dari Panjang 'N' 
...
{ 
	...
	{ 
	 	if (root->isleaf == 1)
	 		...
	 		}// cek apakah root nerupakan leaf  return root; 
...
{  
	...
	Dengan Root 6 dan memiliki anak kiri (1, 2, 4) dam kanan (7,8,9)  6  
	/ \  
	1 2 4 7 8 9  
	  
	Kemudian ditambahkan elemen nilai 5, dan B-Tree menjadi:  4 7  
	/ \ \  
	1 2 5 6 8 9  
	*/ 
	...
	// Tambahkan Nilai 5  
	cout << "Setelah menambakan elemen 17: " << endl;  
