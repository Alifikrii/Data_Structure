...
int main()
{
    ...
    while (1)
    {
        ...
        cout<<"-----------------"<<endl;
        cout<<"1. Print Out BST"<<endl;
        cout<<"2. Hapus Node Dari Tree"<<endl;
        cout<<"3. Insert Node Kedalam Tree"<<endl;
        cout<<"4. EXIT"<<endl;
        ...
        switch(choice)
        {
            ...
            case 3:
                temp = new node;
                cout<<"Ketik angka yang akan ditambahkan ke BST: ";
                cin>>temp->info;
                bst.fun_3(root, temp);
            break;
            case 4:
